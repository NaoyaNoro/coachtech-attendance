...
<div class="detail__content">
    <div class="detail__inner">
        ...
        <form action="/admin/attendance/correct" class="correct__attendance" method="post">
            @csrf
            <table class="detail__table">
                ...
                <tr class="{{ $errors->has('break_start_add') || $errors->has('break_end_add') ? 'no-border' : '' }}">
                    ...
                    <td class="td__first">
                        <input type="text" name="break_start_add" value="" {{$isUnApproved ||$isApproved  ? 'readonly' : ''}}>
                    </td>
                    <td class="td__second">
                        〜
                    </td>
                    <td class="td__third">
                        <input type="text" name="break_end_add" value="" {{$isUnApproved ||$isApproved  ? 'readonly' : ''}}>
                    </td>
                    <td class="td__empty">
